...
data_out = open("Results/English/resultsThesesShortenedSentences.csv", "w")
# convert the data to a csv and write it into the given file
data_out.write(df_fog.to_csv())
data_out.close()

# store variances
data_out = open("Results/English/variancesThesesShortenedSentences.csv", "w")
df_var = pd.DataFrame(variances)
data_out.write(df_var.to_csv())
data_out.close()


print("The collected data has been written to 'Results/English/resultsThesesShortenedSentences.csv' and 'Results/English/variancesThesesShortenedSentences.csv'. \nGo, have a look!")
