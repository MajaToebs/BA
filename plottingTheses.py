...
for m in [1000, 750, 500, 450, 400, 350, 300, 250, 200, 150, 100, 75, 50, 40, 30, 20, 10]:
    ...
    plt.savefig('Plots/thesis/' + str(m) + 'longChunksBoxplottedAllTheses.svg')
...
for m in [100, 75, 50, 40, 30, 20, 10]:
    for thesis in all_theses:
        ...
        plt.figtext(0.995, 0.01, 'the chunk size is ' + str(m), ha='right', va='bottom')
        plt.savefig('Plots/thesis/' + str(m) + "_long_" + thesis + 'indicesOverNumberOfChunk.svg')
...
for thesis in all_theses:
    ...
    plt.savefig('Plots/thesis/' + thesis + 'indicesOverChunkSize.svg')
